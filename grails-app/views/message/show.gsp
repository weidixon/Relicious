	...
	<body>
		...
		<div id="show-message" class="content scaffold-show" role="main">
			...
			<ol class="property-list message">
				...
				<g:if test="${messageInstance?.messageContent}">
				<li class="fieldcontain">
					<span id="messageContent-label" class="property-label"><g:message code="message.messageContent.label" default="Message Content" /></span>
					
						<span class="property-value" aria-labelledby="messageContent-label"><g:fieldValue bean="${messageInstance}" field="messageContent"/></span>
