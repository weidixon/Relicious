			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="messageContent" title="${message(code: 'message.messageContent.label', default: 'Message Content')}" />
				...
				<g:each in="${messageInstanceList}" status="i" var="messageInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${messageInstance.id}">${fieldValue(bean: messageInstance, field: "messageContent")}</g:link></td>
