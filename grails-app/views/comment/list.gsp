			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="photo" title="${message(code: 'comment.photo.label', default: 'Photo')}" />
					
						<g:sortableColumn property="dateCreated" title="${message(code: 'comment.dateCreated.label', default: 'Date Created')}" />
					
						<th><g:message code="comment.recipe.label" default="Recipe" /></th>
				...
				<g:each in="${commentInstanceList}" status="i" var="commentInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: commentInstance, field: "recipe")}</td>
