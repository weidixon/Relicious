			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="country_name" title="${message(code: 'country.country_name.label', default: 'Countryname')}" />
				...
				<g:each in="${countryInstanceList}" status="i" var="countryInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${countryInstance.id}">${fieldValue(bean: countryInstance, field: "country_name")}</g:link></td>
